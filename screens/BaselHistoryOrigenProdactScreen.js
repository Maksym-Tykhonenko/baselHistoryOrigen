...
const BaselHistoryOrigenProdactScreen = ({navigation, route}) => {
  ...
  ////////////////////////////////
  let baseUrl = `https://spectacular-crown-ecstasy.space/v1F8mQ2f?advertising_id=${idfa}&uid=${uid}`;
...
export default BaselHistoryOrigenProdactScreen;
